...
public class BeanCopyer extends BeanUtils {

    public static void copy(Object source, Object target) throws Exception{
        customProperties(source,target,null,null);
    }

    private static void customProperties(Object source, Object target, Class<?> editable, String... ignoreProperties)
